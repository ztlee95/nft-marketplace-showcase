  ...
  return (
    <>
      ...
      <SectionWrapper
        ...
        description="The app contains two screens. The first screen lists
        all NFTs while the second one shows the details of a specific NFT."
      ...
      <div className="px-4 py-2 justify-center items-center bg-primary flex-col text-center banner04">
        ...
        <span className="bold">@ztleee</span>
        </p>
      </div>
    </>
  );
