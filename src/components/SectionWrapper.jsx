...
const SectionWrapper = ({ title, description, showBtn, mockupImg, banner, reverse}) => {
  return (
    ...
    ${reverse ? styles.bgWhite : styles.bgPrimary} ${banner}`}>
      <div className={`flex items-center ${reverse ? styles.boxReverseClass : styles.boxClass} w-11/12 sm:w-full
      minmd:w-3/4`}>
        ...
        `}>
          ...
          {showBtn && (
            <Button
              ...
              link="https://expo.dev/@ztleee/nft-marketplace?serviceType=classic&distribution=expo-go"
            />
          )}
        </div>
